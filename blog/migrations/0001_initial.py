# Generated by Django 6.1 on 2026-08-22 10:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Адміністратор'), ('moderator', 'Модератор'), ('user', 'Користувач')], default='user', max_length=20)),
